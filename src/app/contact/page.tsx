...
export default function ContactPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "ContactPage", "name": "Contact BabyPillars", "url": "https://babypillars.com/contact/", "description": "Get in touch with the BabyPillars team.", "mainEntity": {"@type": "Organization", "name": "BabyPillars", "url": "https://babypillars.com"}}) }} />
      {/* Hero */}
