...
export default function AboutPage() {
  const jsonLd = {
    ...
    jobTitle: "Child Development Specialist & Founder",
    image: "https://babypillars.com/anat.jpg",
    description:
      "Child development specialist with over 20 years of clinical experience. Founder of BabyPillars, an environment-first developmental guidance system for parents.",
